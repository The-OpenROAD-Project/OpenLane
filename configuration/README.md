...
| `DETAILED_ROUTER` | Specifies which detailed router to use. Values: `tritonroute` or `drcu`. <br> (Default: `tritonroute`) |
...
| `RUN_KLAYOUT_DRC` | Enables running Klayout DRC on GDS-II. 1 = Enabled, 0 = Disabled <br> (Default: `1`)|
