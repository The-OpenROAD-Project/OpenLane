...
```bash
    git clone https://github.com/efabless/openlane.git --branch v0.3
    cd openlane/
...
```bash
    git clone https://github.com/efabless/openlane.git --branch v0.3
    docker pull efabless/openlane:v0.3
```

The generated IMAGE_NAME is efabless/openlane:v0.3
...
* **Note:**
    - Default PDK_ROOT is `$(pwd)/pdks`. If you have installed the PDK at a different location, run the following before `make mount`:
        ...
        ```
    - Default IMAGE_NAME is efabless/openlane:v0.3. If you want to use a different version, run the following before `make mount`:
        ```bash
