...
> On Linux, follow the [Docker post install](https://docs.docker.com/engine/install/linux-postinstall/), after you install Docker.
...
See the installation docs at https://openlane.readthedocs.io/en/latest/getting_started/installation.html.
