...
def cleanup(vio_type):
    return str(vio_type).replace(" ","_")#.replace(">","_greater_than_").replace("<","_less_than_").replace("=","_equal_").replace("!","_not_").replace("^","_power_").replace(".","_dot_").replace("-","_dash_").replace("+","_plus_").replace("(","").replace(")","")
