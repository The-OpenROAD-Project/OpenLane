...
file rename -force $::env(TMP_DIR)/magic/$::env(DESIGN_NAME).mag $::env(magic_tmpfiles)_gds_ptrs.mag

puts "\[INFO\]: Wrote $::env(magic_tmpfiles)_gds_ptrs.mag including GDS pointers."
exit 0
