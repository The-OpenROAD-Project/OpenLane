...
class Report:
    ...
    values = ['design', 'design_name','config', 'runtime','DIEAREA_mm^2','CellPer_mm^2' ,'OpenDP_Util','Peak_Memory_Usage_MB','cell_count',
            ...
            'Magic_violations', 'antenna_violations', 'wire_length', 'vias', 'wns', 'optimized_wns', 'fastroute_wns' ,'spef_wns',
            'tns', 'optimized_tns', 'fastroute_tns' , 'spef_tns', 'HPWL', 'wires_count','wire_bits','public_wires_count',
