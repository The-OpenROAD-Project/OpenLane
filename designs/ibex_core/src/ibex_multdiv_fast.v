...
module ibex_multdiv_fast (
	...
	output wire valid_o;
	// removed typedef: opcode_e
	// removed typedef: alu_op_e
	// removed typedef: md_op_e
	// removed typedef: csr_op_e
	// removed typedef: priv_lvl_e
	// removed typedef: x_debug_ver_e
	// removed typedef: op_a_sel_e
	// removed typedef: imm_a_sel_e
	// removed typedef: op_b_sel_e
	// removed typedef: imm_b_sel_e
	// removed typedef: rf_wd_sel_e
	// removed typedef: pc_sel_e
	// removed typedef: exc_pc_sel_e
	// removed typedef: exc_cause_e
	// removed typedef: dbg_cause_e
	parameter [31:0] PMP_MAX_REGIONS = 16;
	parameter [31:0] PMP_CFG_W = 8;
	parameter [31:0] PMP_I = 0;
	parameter [31:0] PMP_D = 1;
	// removed typedef: pmp_req_e
	// removed typedef: pmp_cfg_mode_e
	// removed typedef: pmp_cfg_t
	// removed typedef: csr_num_e
	...
	// removed typedef: mult_fsm_e
	reg [1:0] mult_state_q;
	reg [1:0] mult_state_n;
	// removed typedef: md_fsm_e
	reg [2:0] md_state_q;
	reg [2:0] md_state_n;
