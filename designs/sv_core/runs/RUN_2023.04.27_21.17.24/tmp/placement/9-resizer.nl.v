module core (clk_i,
 ...
 sky130_fd_sc_hd__dfrtp_4 _4911_ (.CLK(clk_i),
    ...
    .RESET_B(net282),
    .Q(net225));
 sky130_fd_sc_hd__dfrtp_4 _4912_ (.CLK(clk_i),
    .D(_0092_),
    .RESET_B(net282),
    .Q(net226));
 sky130_fd_sc_hd__dfrtp_4 _4913_ (.CLK(clk_i),
    .D(_0093_),
    .RESET_B(net282),
    .Q(net227));
 ...
 sky130_fd_sc_hd__dfrtp_4 _4915_ (.CLK(clk_i),
    ...
    .RESET_B(net282),
    .Q(net229));
 sky130_fd_sc_hd__dfrtp_4 _4916_ (.CLK(clk_i),
    .D(_0096_),
    .RESET_B(net282),
    .Q(net230));
 sky130_fd_sc_hd__dfrtp_4 _4917_ (.CLK(clk_i),
    ...
    .RESET_B(net282),
    .Q(net231));
 sky130_fd_sc_hd__dfrtp_4 _4918_ (.CLK(clk_i),
    .D(_0098_),
    .RESET_B(net282),
    .Q(net201));
 sky130_fd_sc_hd__dfrtp_4 _4919_ (.CLK(clk_i),
    .D(_0099_),
    .RESET_B(net286),
    .Q(net202));
 sky130_fd_sc_hd__dfrtp_4 _4920_ (.CLK(clk_i),
    .D(_0100_),
    .RESET_B(net282),
    .Q(net203));
 sky130_fd_sc_hd__dfrtp_4 _4921_ (.CLK(clk_i),
    .D(_0101_),
    .RESET_B(net286),
    .Q(net204));
 sky130_fd_sc_hd__dfrtp_4 _4922_ (.CLK(clk_i),
    .D(_0102_),
    .RESET_B(net286),
    .Q(net205));
 sky130_fd_sc_hd__dfrtp_4 _4923_ (.CLK(clk_i),
    ...
    .RESET_B(net286),
    .Q(net206));
 sky130_fd_sc_hd__dfrtp_4 _4924_ (.CLK(clk_i),
    .D(_0104_),
    .RESET_B(net286),
    .Q(net207));
 sky130_fd_sc_hd__dfrtp_4 _4925_ (.CLK(clk_i),
    .D(_0105_),
    .RESET_B(net286),
    .Q(net208));
 sky130_fd_sc_hd__dfrtp_4 _4926_ (.CLK(clk_i),
    ...
    .RESET_B(net286),
    .Q(net209));
 sky130_fd_sc_hd__dfrtp_4 _4927_ (.CLK(clk_i),
    .D(_0107_),
    .RESET_B(net288),
    .Q(net210));
 sky130_fd_sc_hd__dfrtp_4 _4928_ (.CLK(clk_i),
    .D(_0108_),
    .RESET_B(net288),
    .Q(net212));
 sky130_fd_sc_hd__dfrtp_4 _4929_ (.CLK(clk_i),
    .D(_0109_),
    .RESET_B(net288),
    .Q(net213));
 sky130_fd_sc_hd__dfrtp_4 _4930_ (.CLK(clk_i),
    .D(_0110_),
    .RESET_B(net288),
    .Q(net214));
 sky130_fd_sc_hd__dfrtp_4 _4931_ (.CLK(clk_i),
    .D(_0111_),
    .RESET_B(net291),
    .Q(net215));
 sky130_fd_sc_hd__dfrtp_4 _4932_ (.CLK(clk_i),
    ...
    .RESET_B(net292),
    .Q(net216));
 sky130_fd_sc_hd__dfrtp_4 _4933_ (.CLK(clk_i),
    .D(_0113_),
    .RESET_B(net291),
    .Q(net217));
 sky130_fd_sc_hd__dfrtp_4 _4934_ (.CLK(clk_i),
    .D(_0114_),
    .RESET_B(net292),
    .Q(net218));
 sky130_fd_sc_hd__dfrtp_4 _4935_ (.CLK(clk_i),
    .D(_0115_),
    .RESET_B(net292),
    .Q(net219));
 sky130_fd_sc_hd__dfrtp_4 _4936_ (.CLK(clk_i),
    .D(_0116_),
    .RESET_B(net292),
    .Q(net220));
 sky130_fd_sc_hd__dfrtp_4 _4937_ (.CLK(clk_i),
    .D(_0117_),
    .RESET_B(net292),
    .Q(net221));
 sky130_fd_sc_hd__dfrtp_4 _4938_ (.CLK(clk_i),
    .D(_0118_),
    .RESET_B(net291),
    .Q(net223));
 sky130_fd_sc_hd__dfrtp_4 _4939_ (.CLK(clk_i),
    .D(_0119_),
    .RESET_B(net291),
    .Q(net224));
 ...
 sky130_fd_sc_hd__dfrtp_4 _5199_ (.CLK(clk_i),
    ...
    .RESET_B(net289),
    .Q(net278));
 sky130_fd_sc_hd__dfrtp_4 _5200_ (.CLK(clk_i),
 ...
 sky130_fd_sc_hd__dfrtp_4 _5202_ (.CLK(clk_i),
    .D(_0201_),
    .RESET_B(net290),
    .Q(net200));
 sky130_fd_sc_hd__dfrtp_4 _5203_ (.CLK(clk_i),
    .D(_0202_),
    .RESET_B(net289),
    .Q(net211));
