...
| `detailed_routing` | | Runs detailed routing on the processed design using OpenROAD TritonRoute. The resulting file is under `/<run_path>/results/routing/` . |
...
| `detailed_routing_drcu` | | **Removed: Aliases detailed_routing**: Runs detailed routing on the processed design using DRCU. The resulting file is under `/<run_path>/results/routing/` . |
| `detailed_routing_tritonroute` | | **Removed: Aliases detailed_routing**:  Runs detailed routing on the processed design using OpenROAD TritonRoute based on the value of `DETAILED_ROUTER`. The resulting file is under `/<run_path>/results/routing/` . |
## Magic Commands
