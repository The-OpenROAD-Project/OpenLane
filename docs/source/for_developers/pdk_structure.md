...
| `FP_IO_HORIZONTAL_LAYER`  | The metal layer on which to place the io pins horizontally (top and bottom of the die). <br>(Example: `met3`)|
| `FP_IO_VERTICAL_LAYER`  | The metal layer on which to place the io pins vertically (sides of the die) <br> (Example: `met2`)|
| `FP_PDN_CORE_RING_HORIZONTAL_OFFSET` | Defines the offset for the horizontal layer used to create the core ring in the PDN. <br> (Example: `20`) | |
| `FP_PDN_CORE_RING_HORIZONTAL_SPACING` | Defines the spacing for the horizontal layer used to create the core ring in the PDN. <br> (Example: `5`) | |
| `FP_PDN_CORE_RING_HORIZONTAL_WIDTH` | Defines the horizontal width for the horizontal layer used to create the core ring in the PDN. <br> (Example: `20`) | |
| `FP_PDN_CORE_RING_VERTICAL_OFFSET` | Defines the offset for the vertical layer used to create the core ring in the PDN. <br> (Example: `20`) | |
| `FP_PDN_CORE_RING_VERTICAL_SPACING` | Defines the spacing for the vertical layer used to create the core ring in the PDN. <br> (Example: `5`) | |
| `FP_PDN_CORE_RING_VERTICAL_WIDTH` | Defines the vertical width for the vertical layer used to create the core ring in the PDN. <br> (Example: `20`) | |
| `FP_PDN_HORIZONTAL_OFFSET`  | The offset of the horizontal power stripes on the metal layer 5 in the power distribution network <br> (Default: `16.65`) |
...
| `FP_PDN_HORIZONTAL_SPACING`  | The spacing between power/ground pairs in the horizontal direction <br> (Default: `16.32`) |
| `FP_PDN_HORIZONTAL_WIDTH` | Defines the strap width for the horizontal layer used in PDN. <br> (Example: `1.6`) | |
| `FP_PDN_RAIL_OFFSET` | Defines the rail offset for met1 used in PDN. <br> (Example: `0`) | |
| `FP_PDN_VERTICAL_OFFSET`  | The offset of the vertical power stripes on the metal layer 4 in the power distribution network <br> (Default: `16.32`) |
...
| `FP_PDN_VERTICAL_SPACING`  | The spacing between power/ground pairs in the verital direction <br> (Default: `16.32`) |
| `FP_PDN_VERTICAL_WIDTH` | Defines the strap width for the vertical layer used in PDN. <br> (Example: `1.6`) | |
| `FP_TAPCELL_DISTANCE` | The distance between tapcell columns. Used in floorplanning in tapcell insertion. |
...
| `FP_PDN_HORIZONTAL_LAYER` | Defines the horizontal layer used in PDN. |
...
| `FP_PDN_VERTICAL_LAYER` | Defines the vertical layer used in PDN. |
...
| `STD_CELL_POWER_PINS` | Defines ground pins of stdcells. Used in PDN |
