...
| `DOCKER_IMAGE` | The name of the Docker image used. While it is not a secret, we don't want to define it on the repository level as that would create complications with forks. |
